...
var G__51625 = o;
goog.object.set(G__51625,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__51669 = o;
goog.object.set(G__51669,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51875__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51875 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__51876__i < G__51876__a.length) {G__51876__a[G__51876__i] = arguments[G__51876__i + 0]; ++G__51876__i;}
  args = new cljs.core.IndexedSeq(G__51876__a,0,null);
} 
return G__51875__delegate.call(this,args);};
G__51875.cljs$lang$maxFixedArity = 0;
G__51875.cljs$lang$applyTo = (function (arglist__51878){
var args = cljs.core.seq(arglist__51878);
return G__51875__delegate(args);
});
...
var G__51689 = props;
var G__51689__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51689,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51689);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51689__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51731 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51731,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51731;
}
})(),id_class);
...
var G__51753 = (cljs.core.count(argv) - first_child);
switch (G__51753) {
case (0):
...
var vec__51803 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51803,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51803,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51803,(2),null);
...
var temp__5758__auto___51880 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___51880 == null)){
} else {
var key_51881 = temp__5758__auto___51880;
(jsprops.key = key_51881);
}
...
var temp__5758__auto___51882 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___51882 == null)){
} else {
var key_51883 = temp__5758__auto___51882;
(jsprops.key = key_51883);
}
...
var temp__5758__auto___51888 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5758__auto___51888 == null)){
} else {
var key_51889 = temp__5758__auto___51888;
(jsprops.key = key_51889);
}
...
var temp__5758__auto___51890 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___51890 == null)){
} else {
var key_51891 = temp__5758__auto___51890;
(jsprops.key = key_51891);
}
...
var temp__5758__auto___51892 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___51892 == null)){
} else {
var key_51894 = temp__5758__auto___51892;
(jsprops.key = key_51894);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51843_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__51843_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__51847 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51847,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51847,(1),null);
...
break;
default:
var G__51915 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51916 = compiler;
v = G__51915;
compiler = G__51916;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template51868 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template51868 = (function (opts,id,fn_to_element,meta51869){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template51868.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51870,meta51869__$1){
var self__ = this;
var _51870__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template51868(self__.opts,self__.id,self__.fn_to_element,meta51869__$1));
}));

(reagent.impl.template.t_reagent$impl$template51868.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51870){
var self__ = this;
var _51870__$1 = this;
return self__.meta51869;
}));

(reagent.impl.template.t_reagent$impl$template51868.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template51868.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template51868.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template51868.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template51868.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta51869","meta51869",-2042076798,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template51868.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template51868.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template51868");

(reagent.impl.template.t_reagent$impl$template51868.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template51868");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template51868.
 */
reagent.impl.template.__GT_t_reagent$impl$template51868 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template51868(opts__$1,id__$1,fn_to_element__$1,meta51869){
return (new reagent.impl.template.t_reagent$impl$template51868(opts__$1,id__$1,fn_to_element__$1,meta51869));
});

}

return (new reagent.impl.template.t_reagent$impl$template51868(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
