...
var fipp$ednize$IEdn$_edn$dyn_41597 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_41597(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4622__auto__ = (function fipp$ednize$edn_$_iter__41557(s__41558){
return (new cljs.core.LazySeq(null,(function (){
var s__41558__$1 = s__41558;
while(true){
var temp__5754__auto__ = cljs.core.seq(s__41558__$1);
if(temp__5754__auto__){
var s__41558__$2 = temp__5754__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41558__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__41558__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__41560 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__41559 = (0);
while(true){
if((i__41559 < size__4621__auto__)){
var k = cljs.core._nth(c__4620__auto__,i__41559);
cljs.core.chunk_append(b__41560,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__41612 = (i__41559 + (1));
i__41559 = G__41612;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41560),fipp$ednize$edn_$_iter__41557(cljs.core.chunk_rest(s__41558__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41560),null);
}
} else {
var k = cljs.core.first(s__41558__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__41557(cljs.core.rest(s__41558__$2)));
}
} else {
return null;
}
