...
return cljs.core.name(G__51142);
} else {
return G__51142;
}
});
...
var temp__5756__auto__ = (o[k_STAR_]);
if((temp__5756__auto__ == null)){
return (o[k_STAR_] = ({}));
} else {
var child_obj = temp__5756__auto__;
return child_obj;
}
});
/**
...
var G__51170 = (i + (1));
var G__51171 = (obj__$1[cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ks_STAR_,i)]);
i = G__51170;
obj__$1 = G__51171;
continue;
}
...
var temp__5756__auto__ = applied_science.js_interop.impl.get_value_by_keys(obj,cljs.core.butlast(ks_STAR_));
if((temp__5756__auto__ == null)){
return not_found;
} else {
var last_obj = temp__5756__auto__;
