...
var i_43480 = (self__.level + (1));
while(true){
if((i_43480 <= (new_level + (1)))){
(update[i_43480] = self__.header);

var G__43481 = (i_43480 + (1));
i_43480 = G__43481;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43483 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43483[i]));
} else {
x__$2.forward.push((((i < links_43483.length))?(links_43483[i]):null));
}

if((i < links_43483.length)){
(links_43483[i] = x__$2);
} else {
links_43483.push(x__$2);
}
...
var i_43486 = (0);
while(true){
if((i_43486 <= self__.level)){
var links_43487 = (update[i_43486]).forward;
if((x__$1 === (((i_43486 < links_43487.length))?(links_43487[i_43486]):null))){
(links_43487[i_43486] = (x__$1.forward[i_43486]));

var G__43489 = (i_43486 + (1));
i_43486 = G__43489;
continue;
} else {
var G__43490 = (i_43486 + (1));
i_43486 = G__43490;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__43507 = nx;
var G__43508 = (level__$1 - (1));
x = G__43507;
level__$1 = G__43508;
continue;
} else {
var G__43509 = x;
var G__43510 = (level__$1 - (1));
x = G__43509;
level__$1 = G__43510;
continue;
}
