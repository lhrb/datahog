...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47436){
var map__47437 = p__47436;
var map__47437__$1 = cljs.core.__destructure_map(map__47437);
var request = map__47437__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47437__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__47441 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47441.cljs$core$IFn$_invoke$arity$1 ? fexpr__47441.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47441.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__47442 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47442.cljs$core$IFn$_invoke$arity$1 ? fexpr__47442.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47442.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__47444){
var map__47445 = p__47444;
var map__47445__$1 = cljs.core.__destructure_map(map__47445);
var request = map__47445__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47445__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
