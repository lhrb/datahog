...
return [(function (){var pred__41558 = cljs.core.instance_QMARK_;
var expr__41559 = reactive_val;
if(cljs.core.truth_((pred__41558.cljs$core$IFn$_invoke$arity$2 ? pred__41558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__41559) : pred__41558.call(null,reagent.ratom.RAtom,expr__41559)))){
return "ra";
} else {
if(cljs.core.truth_((pred__41558.cljs$core$IFn$_invoke$arity$2 ? pred__41558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__41559) : pred__41558.call(null,reagent.ratom.RCursor,expr__41559)))){
return "rc";
} else {
if(cljs.core.truth_((pred__41558.cljs$core$IFn$_invoke$arity$2 ? pred__41558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__41559) : pred__41558.call(null,reagent.ratom.Reaction,expr__41559)))){
return "rx";
} else {
if(cljs.core.truth_((pred__41558.cljs$core$IFn$_invoke$arity$2 ? pred__41558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__41559) : pred__41558.call(null,reagent.ratom.Track,expr__41559)))){
return "tr";
} else {
return "other";
}
